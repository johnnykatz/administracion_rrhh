...
<div class="col-md-6">
    <div class="box box-primary">
        ...
        {{--</div>--}}
        <div class="box-body">
            <a href="{!! route('generarSituacionRevista',[$agente->id]) !!}" target="_blank" class="btn btn-default">Imprimir Situacion de Revista</a>
        </div>
    </div>
</div>
{{--</div>--}}
                    ...
                    <div class="box-body">
                        <table class="record_properties">
                            ...
                            <tr>
                                ...
                                <td>
                                    {!!(isset($agente->puestoTrabajo->tipoInstrumentoLegal))?$agente->puestoTrabajo->tipoInstrumentoLegal->nombre_corto." ".$agente->puestoTrabajo->numero_instrumento:null !!}
                                </td>
                            </tr>
                            <tr>
